...
### 6. `registry status` を CI のゲートにする
...
### 13. リビルドした index に Story が現れることを確認する
...
機械による確認は項目 13 の index のチェックまでとします。
